...
using TallyProofs
using TallyProofs: Enc, Dec, ElGamalRow

import CryptoGroups
import CryptoGroups: PGroup, specialize, <|, generator, ECGroup
...
function elgamal_test(g)
    ...
    @test sort(messages) == sort(dec(messages_enc))
