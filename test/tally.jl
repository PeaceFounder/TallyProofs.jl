...
simulator = tally(cast_commitments, cast_oppenings, verifier; skip_list = [g^ted_key])
...
tchg = tracker_challenge(simulator.proposition, cast_proofs, members, ted_receipt, hasher)
ted_tracker = compute_tracker(ted, tchg, pin) # this is a hash of the tracker
