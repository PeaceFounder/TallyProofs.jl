...
# function Base.broadcasted(::typeof(*), x::NTuple{N, G}, y::ElGamalElement{G}) where {N, G <: Group}
#     return ElGamalRow{G}(tuple([i * y for i in x.row]...))
# end
...
# This should work out of the box for the vector
